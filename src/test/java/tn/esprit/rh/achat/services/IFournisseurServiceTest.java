...
class IFournisseurServiceTest {
    ...
    DetailFournisseur df = new DetailFournisseur("medalaa@duck.com", new Date(), "tunisie", "azerty");
    List<Fournisseur> fournisseurList = new ArrayList<Fournisseur>(){
        {
            add(new Fournisseur("code0", "libelle0", CategorieFournisseur.ORDINAIRE));
            add(new Fournisseur("code1", "libelle1", CategorieFournisseur.CONVENTIONNE));
        }
    };
